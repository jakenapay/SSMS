                        ...
                        <div class="restock_supplies">
                            <div class="form-group my-2">
                                ...
                                <select class="form-select" id="restock_item" name="restock_item" aria-label="Default select example" required>
                                    ...
                                    $sql = "SELECT ts_id as id, ts_quantity as quantity, ts_name as item, ts_location as location FROM epiz_33456032_ssms.technology_supplies";
                        ...
                        <div class="restock_supplies">
                            <div class="form-group my-2">
                                ...
                                <select class="form-select" id="restock_item" name="restock_item" aria-label="Default select example" required>
                                    ...
                                    <?php
                                    include 'includes/config.inc.php';
                                    $sql = "SELECT os_id as id, os_quantity as quantity,os_name as item, os_location as location FROM epiz_33456032_ssms.office_supplies";
                                    $result = $conn->query($sql);
                                    if ($result->num_rows > 0) {
                                        // output data of each row
                                        while ($row = $result->fetch_assoc()) {
                            ...
                            <tbody>
                                ...
                                if ((isset($_SESSION['ct']) and ($_SESSION['ct']) == 'user')) {
                                    $sql = "SELECT \n"
                                        ...
                                        . "FROM epiz_33456032_ssms.restocks r\n"
                                        ...
                                        . "LEFT JOIN epiz_33456032_ssms.users u ON r.user_id = u.user_id\n"
                                        . "WHERE u.user_id=" . $id . "\n"
