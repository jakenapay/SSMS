            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-md-6 col-lg-7">
                    <div class="box-content">
                        <form method="POST" action="includes/os.inc.php">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 pb-3">
                                    ...
                                    <input id="os_id" name="os_id" type="hidden" class="form-control" placeholder="Id" value="<?php echo $osid; ?>">
                                    <p class="pt-2 pb-1 px-2 border rounded align-items-center"><?php echo $osid; ?></p>
                                </div>
                                <div class="col-md-8 pb-3">
                                    <label for="os_name">Name</label>
                                    <input id="os_name" name="os_name" type="text" class="form-control" placeholder="Enter Name" value="<?php echo $name; ?>">
                                </div>
                                <div class="col-md-6 pb-3">
                                    <label for="os_brand">Brand</label>
                                    <input id="os_brand" name="os_brand" type="text" class="form-control" placeholder="Brand" value="<?php echo $brand; ?>">
                                </div>
                                <div class="col-md-6 pb-3">
                                    <label for="os_uom">Unit of Measure</label>
                                    <input id="os_uom" name="os_uom" type="text" class="form-control" placeholder="Category" value="<?php echo $uom; ?>">
                                </div>
                                <div class="col-md-6 pb-3">
                                    <label for="os_quantity">Quantity (<a href="restocks.php?rid=<?php echo $osid; ?>">Restock here</a>)</label>
                                    <input id="os_quantity" name="os_quantity" type="hidden" class="form-control" placeholder="Quantity" value="<?php echo $qty; ?>">
                                ...
                                <div class="form-input d-flex justify-content-between align-items-center px-4">
                                    <a href="officeSupplies.php">Back</a>
                    ...
                    <div class="box-content">
                        ...
                        <form action="includes/os.inc.php" method="post" enctype="multipart/form-data">
                            <div class="col-md-12 pt-1 pb-4 d-flex justify-content-center flex-column align-items-center">
                                ...
                                <input type="hidden" name="os_id" value="<?php echo $osid; ?>">
                                <input type="hidden" name="uid" value="<?php echo $_SESSION['id']; ?>">

                                <?php
                                if ($old_img != '') {
                                    // if there's an existing image then echo the image
                                    echo '<img src="officeSupplies/' . $old_img . '" alt="" class="img-fluid pb-5" style="width: 300px;">';
                                } else {
                                    echo '<label class="m-5">No image found.</label>';
                                }
                                ?>
                                <input type="file" accept="image/*" name="os_img" id="os_img">
