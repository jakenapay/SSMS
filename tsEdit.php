...
if (isset($_GET['eid']) and ($_GET['eid']) != '') {
    ...
    $id = $_GET['eid'];
    $result = $conn->query("SELECT *, CONCAT(epiz_33456032_ssms.users.user_firstname, ' ', epiz_33456032_ssms.users.user_lastname) as fullname FROM epiz_33456032_ssms.technology_supplies INNER JOIN epiz_33456032_ssms.users ON epiz_33456032_ssms.technology_supplies.modified_by=epiz_33456032_ssms.users.user_id WHERE ts_id = $id LIMIT 1");
