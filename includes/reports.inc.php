...
if (isset($_POST['report-office-btn'])) {
    ...
    $sql = "INSERT INTO `reports` (`os_id`, `report_description`, `report_by`, `report_date`) VALUES ('$osid', '$des', '$by', now());";
...
if (isset($_POST['report-tech-btn'])) {
    ...
    $sql = "INSERT INTO `reports` (`ts_id`, `report_description`, `report_by`, `report_date`) VALUES ('$tsid', '$des', '$by', now());";
