...
if (isset($_POST['check_view'])) {
    ...
    $result = $conn->query("SELECT u.user_id, u.user_firstname, u.user_lastname, u.user_email, u.user_img, u.user_category, u.user_status, u.user_date, u.date_last_modified, us.modified_by as Modified_by FROM `epiz_33456032_ssms`.`users` as u INNER JOIN `epiz_33456032_ssms`.`users` as us ON u.user_id=us.user_id WHERE u.user_id=$user_id");
