...
if (isset($_POST['save-btn'])) {
    ...
    // sql query
    $sql = "UPDATE epiz_33456032_ssms.users SET user_firstname='$fname', user_lastname='$lname', user_email='$email', user_password='$pw', date_last_modified='$now' WHERE user_id=$id";
...
if (isset($_POST['delete-confirm-btn'])) {
    ...
    $sql = "UPDATE epiz_33456032_ssms.users SET user_status='inactive', date_last_modified='$now' WHERE user_id=$id";
    if ($conn->query($sql) === TRUE) {
